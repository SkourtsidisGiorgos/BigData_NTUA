Script started on Sun 21 Mar 2021 09:06:02 PM EET
]0;user@master: ~/ergasia/meros1user@master:~/ergasia/meros1$ spark-submit q5rdd.py
21/03/21 21:06:14 WARN NativeCodeLoader: Unable to load native-hadoop library for your platform... using builtin-java classes where applicable
Genre | User Id | Ratings | Favorite Movie | Rating | Least Favorite | Rating
...
Q5_RDD Execution time: 818.9369204044342 seconds
]0;user@master: ~/ergasia/meros1user@master:~/ergasia/meros1$ εχιτ[K[K[K[Kexit
exit

Script done on Sun 21 Mar 2021 09:50:02 PM EET
